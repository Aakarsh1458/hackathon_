...
/// Base safe container for modules — never imports module internals.
...
class EmotionModuleContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const ModuleContainer(
      ...
      fallbackDescription:
          'Awaiting module drop-in at `modules/emotion_engine/`.\n'
...
class AICoreContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const ModuleContainer(
      ...
      fallbackDescription:
          'Awaiting module drop-in at `modules/ai_core/`.\n'
          'Expose a facade implementing `WellnessModuleContract` and register it.',
...
class CompanionModuleContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const ModuleContainer(
      ...
      fallbackDescription:
          'Awaiting module drop-in at `modules/companion_system/`.\n'
          'Expose a facade implementing `WellnessModuleContract` and register it.',
...
class InterventionModuleContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const ModuleContainer(
      ...
      fallbackDescription:
          'Awaiting module drop-in at `modules/intervention_system/`.\n'
          'Expose a facade implementing `WellnessModuleContract` and register it.',
